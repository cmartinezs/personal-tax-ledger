...
export function createMortgageComposition(dependencies) {
  const mortgageRepository = dependencies?.mortgageRepository || createSqliteMortgageRepository();
  const mortgageAnnualRecordRepository = dependencies?.mortgageAnnualRecordRepository || createSqliteMortgageAnnualRecordRepository();
