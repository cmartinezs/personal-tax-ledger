...
`desktop:dev` compila primero `apps/local/web/dist` y luego ejecuta Electron 44.2.0 mediante `npx`. Este mecanismo es únicamente el puente de desarrollo y UAT técnico; no es la distribución prevista para usuarios finales.
