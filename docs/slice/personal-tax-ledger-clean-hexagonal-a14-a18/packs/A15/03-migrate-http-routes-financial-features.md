# Pack A15.3 — Migrar routers de boletas e hipotecarios
...
Continuar la extracción HTTP con features financieras.
...
Migrar fee receipts, fee expense settings, mortgages y annual records a `packages/http-api/src/<feature>/`. Consumir application use cases. No acceder a SQLite.

## Fuera de alcance

No cambiar reglas tributarias.

## Validaciones obligatorias

Caracterización HTTP, smoke CRUD, architecture check y búsqueda de imports legacy.

## Definition of Done

Boletas e hipotecarios ya no dependen de `server/routes`.
