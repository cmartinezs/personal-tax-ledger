...
| Copia de ingresos entre años | N/A | NOT_STARTED | NOT_STARTED | NOT_STARTED | PARTIAL (usa `copyIncomeSources` concreto) | N/A | PARTIAL (usa `api.copyIncomes`) | NOT_APPLICABLE | PARTIAL | PARTIAL |
...
| Settings | N/A | NOT_STARTED | NOT_STARTED | NOT_STARTED | PARTIAL | NOT_STARTED | PARTIAL | NOT_APPLICABLE | PARTIAL | PARTIAL |
...
| Execution logs / bitácora | N/A | NOT_STARTED | NOT_STARTED | NOT_STARTED | PARTIAL | NOT_STARTED | PARTIAL | NOT_APPLICABLE | PARTIAL | PARTIAL |
...
- El estado global de cada fila es el mínimo razonable entre sus columnas: una fila con cualquier columna aplicable en `NOT_STARTED` no puede ser `COMPLETE`.
