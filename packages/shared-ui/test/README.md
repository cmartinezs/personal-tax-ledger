...
Renderizan los componentes públicos desde el artefacto compilado. No deben importar componentes de `web/src`; eso garantiza que una app externa pueda consumir el paquete.
