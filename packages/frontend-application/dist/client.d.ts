import type { BootstrapResponse, ExecutionLogFilters, ExecutionLogRequest, ExecutionLogPageResponse, ExecutionLogResponse, FeeExpenseSettingsRequest, FeeExpenseSettingsResponse, FeeReceiptFilters, FeeReceiptRequest, FeeReceiptResponse, IncomeSourceRequest, IncomeSourceResponse, MortgageAnnualRecordFilters, MortgageAnnualRecordRequest, MortgageAnnualRecordResponse, MortgageLoanFilters, MortgageLoanRequest, MortgageLoanResponse, ScenarioResponse, SettingsRequest, SettingsResponse, TaxParameterResponse, TaxParametersFilters, TaxParametersRequest, TaxRuleSourceFilters, TaxRuleSourceRequest, TaxRuleSourceResponse } from '@personal-tax-ledger/api-contracts';
export type FrontendClient = {
    ...
    updateIncome: (source: IncomeSourceRequest & {
        id: number;
    ...
    updateFeeReceipt: (receipt: FeeReceiptRequest & {
        id?: string;
    }) => Promise<FeeReceiptResponse>;
    ...
    updateMortgage: (loan: MortgageLoanRequest & {
        id?: string;
    ...
    updateAnnualRecord: (record: MortgageAnnualRecordRequest & {
        id?: string;
    }) => Promise<MortgageAnnualRecordResponse>;
    ...
    compareApv: (annualContribution: number, sources?: IncomeSourceRequest[], settings?: Partial<SettingsRequest>, modules?: {
        feeReceipts?: FeeReceiptRequest[];
        mortgages?: MortgageLoanRequest[];
        annualRecords?: MortgageAnnualRecordRequest[];
    }) => Promise<unknown>;
    ...
    saveSnapshot: (name: string, payload: Record<string, unknown>) => Promise<{
        id: number;
        result: unknown;
    }>;
