...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {tab === 'fees' && <FeeReceiptsModule settings={settings} taxYear={taxYear} onSettingsChange={patch => updateSettingsState({ ...settings, ...patch })} onSimulationStale={() => refreshFeeReceipts()} />}
